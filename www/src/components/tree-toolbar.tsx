...
export const TreeToolbar = ({
  ...
  <div className='bg-muted/40 flex min-h-9 flex-wrap items-center gap-2 border-b px-2 py-1'>
    <div className='relative h-7 min-w-40 flex-1 sm:w-56 sm:flex-none'>
      ...
      <input
        ...
        className='border-input bg-background h-7 w-full rounded-md border pr-2 pl-7 font-mono text-xs outline-none'
      />
    </div>
    <TreeFilterDialog
      filters={filters}
